...
import { useListHelpersQuery, useAssignHelperMutation } from './agentHelperApi';
...
export function ManageHelpersPanel({ agentId }: ManageHelpersPanelProps): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormError(extractErrorMessage(err, 'Could not assign this helper. Please check your selection and try again.'));
    }
  };
